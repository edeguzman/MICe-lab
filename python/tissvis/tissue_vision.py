...
def TV_stitch_cmd(TV_stitch_options, output_dir: str):
    stage = CmdStage(inputs=(), outputs=(),
                     cmd=['TV_stitch.py', '--clobber', '--keeptmp',
                          ...
                          '--Ystart %s' % TV_stitch_options.Zstart if TV_stitch_options.Ystart else '',
                          '--Yend %s' % TV_stitch_options.Zend if TV_stitch_options.Yend else '',
                          '--Xstart %s' % TV_stitch_options.Zstart if TV_stitch_options.Xstart else '',
                          '--Xend %s' % TV_stitch_options.Zend if TV_stitch_options.Xend else '',
